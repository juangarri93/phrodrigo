<?php
	...
	$from = 'contacto@phrodrigo.com.ar';
	$to3 = 'jmg.93@hotmail.com';
	$to = 'marisa.rodrigo67@gmail.com';  // please change this email id
	...
	$headers = "From: PH Rodrigo - Nuevo Contacto <contacto@phrodrigo.com.ar>";



	$name2 = $_POST['name'];
	$message2 = $_POST['message'];
	$from2 = 'marisa.rodrigo67@gmail.com';
	$to2 = $_POST['email'];
	...
	$headers2 = "From: PH Rodrigo - Consultas <marisa.rodrigo67@gmail.com>";


	//send the email
	$result = '';
	if (mail ($to3, $subject, $body, $headers) && mail ($to, $subject, $body, $headers) && mail ($to2, $subject2, $body2, $headers2)) {
